...
const getProfileIconXml = (color: string) => `
<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="${PROFILE_ICON_PATH}" fill="${color}"/>
</svg>`;

export function AppProfileIcon({ color = '#FF0040', size = 16 }: AppProfileIconProps) {
  return <SvgXml xml={getProfileIconXml(color)} width={size} height={size} />;
}
